...
class GroupInfo extends StatefulWidget {
  final String groupId, groupName,groupUrl;
  const GroupInfo({required this.groupId, required this.groupName, Key? key, required this.groupUrl})
      : super(key: key);
                        ...
                        children: [
                          Container(
                            ...
                            decoration:  BoxDecoration(
                              image: DecorationImage(image: NetworkImage(widget.groupUrl,),fit: BoxFit.cover),
