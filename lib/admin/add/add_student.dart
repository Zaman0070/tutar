...
class _LoginScreenState extends State<AddStudent> {
        ...
        Container(
          ...
          child:  TextFormField(
            ...
            decoration:const InputDecoration(
              ...
              hintText: 'Enter Student Second Name ',
              //  hintStyle: kHintTextStyle,
            ),
          ),
        ),
      ...
      child: ElevatedButton(
        ...
        onPressed: (){
          ...
          if(formKey.currentState!.validate()){
            if(imageUrl!=null){
              services.studentRegister(emailTextController.text, passwordTextController.text, context, scondNameTextController.text,imageUrl,firstNameTextController.text);
            }
            else{
